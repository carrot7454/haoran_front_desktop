 ...
 */
import { addQues, upload } from '@/services/api';
import { PageContainer } from '@ant-design/pro-components';
import { Button, Form, Image, Input, message, Rate, Upload } from 'antd';
    ...
    try {
      ...
      for (let i = 1; i <= pdf.numPages; i++) {
        ...
        const uploadUrl = await upload({
          base64: dataUrl,
          name: file.name + '_image_' + i + new Date().getTime() +'.png',
        });
        console.log('Upload success:', uploadUrl);
        results.push({ page: i, dataUrl: "https://img2.zhishiliu.top/" + uploadUrl.data.key });
  ...
  return (
    <PageContainer title="上传试题">
      <div
        ...
        style={{ fontFamily: 'Segoe UI, Arial', margin: 16 }}
      >
        <Form form={form}>
          <Form.Item
            label="输入试卷名称"
          ...
          <Form.Item label="选择PDF习题" required>
            <Upload type="file" accept="application/pdf" onChange={handleFile}>
